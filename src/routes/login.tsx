  ...
  return (
    <div className='overflow-hidden grid grid-cols-[1fr_480px] h-dvh'>
      ...
      <div className='flex flex-col justify-center px-3'>
        <p className='font-serif text-accent/50 leading text-[80px]/[0.6] mb-5'>"</p>
        <p className='font-serif italic text-2xl/[1.55] tracking-[-0.01em] text-text/85 mb-6'>
          A reader lives a <em className='font-normal not-italic text-accent'>thousand lives</em> before he dies.
      ...
      <div className='flex items-center gap-9'>
        <div>
          <div className='font-bold font-serif text-2xl'>12<span className='text-accent'>k+</span></div>
          <p className='text-[11px] text-muted uppercase font-mono tracking-[0.08em]'>Books tracked</p>
        </div>

        <div className='w-px bg-border h-full' />

        <div>
          <div className='font-bold font-serif text-2xl'>3.4<span className='text-accent'>k</span></div>
          <p className='text-[11px] text-muted uppercase font-mono tracking-[0.08em]'>Active readers</p>
        </div>

        <div className='w-px bg-border h-full' />

        <div>
          <div className='font-bold font-serif text-2xl'>98<span className='text-accent'>%</span></div>
          <p className='text-[11px] text-muted uppercase font-mono tracking-[0.08em]'>Goals reached</p>
        </div>
      </div>
    </div>
    ...
    <div className='flex flex-col justify-center p-[60px_52px] relative bg-noise animate-fade-up [animation-delay:0.15s] stagger-fade-up'>
      ...
      <div className='space-y-3'>
        ...
        >
          ...
          <span className='text-xs transition-transform text-muted ml-auto'>→</span>
        </button>
      ...
      <div className='bg-surface border border-border rounded-[10px] p-[16px_18px] flex gap-3'>
        ...
        <p className='text-xs/[1.6] text-muted'>
          MyBookList uses <strong className='text-text/60 font-medium'>OAuth 2.0</strong> — we never store your password. Your reading data is private and belongs only to you.
        </p>
      </div>

      <footer className='mt-9 text-[11px]/[1.7] text-muted text-center'>
        <p>
          By signing in you agree to our <Link to='/terms' className='hover:underline hover:text-accent'>
            Terms of Service
          </Link> and <Link to='/privacy' className='hover:underline hover:text-accent2'>
            Privacy Policy
          </Link>.
        </p>
      </footer>
